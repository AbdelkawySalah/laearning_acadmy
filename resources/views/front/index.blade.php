               ...
               @foreach($courses as $course)
                <div class="col-sm-6 col-lg-4">
                    <div class="single_special_cource">
                        <img src="{{asset('uploads/courses/'.$course->img)}}" class="special_img" alt="{{$course->img}}">
                        <div class="special_cource_text">
                            <a href="{{route('front.coursescat',$course->cat_id)}}" class="btn_4">{{$course->cat->name}}</a>
                            <h4>${{$course->price}}</h4>
                            <a href="{{route('front.showcourse',[$course->cat_id,$course->id])}}"><h3>{{$course->name}}</h3></a>
                            <p>{{$course->small_desc}}</p>
                            <div class="author_info">
                                <div class="author_img">
                                    <img src="{{asset('uploads/trainers/'.$course->trainer->img)}}" alt="{{$course->trainer->img}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="{{asset('uploads/tests/'.$test->img)}}" alt="{{$test->img}}">
                                    </div>
                                </div>
